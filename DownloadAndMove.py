...
from_dir = "C:/Users/chandrashekhar/Downloads"              # Add the path of you "Downloads" folder.
to_dir = "F:/New folder/WhiteHat Jr/113/New folder" #Create "Document_Files" folder in your Desktop and update the path accordingly.
